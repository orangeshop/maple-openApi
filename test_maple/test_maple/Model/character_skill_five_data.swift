...
//
//   let characterSkillFiveData = try? JSONDecoder().decode(CharacterSkillFiveData.self, from: jsonData)

import Foundation
import OptionallyDecodable // https://github.com/idrougge/OptionallyDecodable

// MARK: - CharacterSkillFiveData
struct CharacterSkillFiveData: Codable {
